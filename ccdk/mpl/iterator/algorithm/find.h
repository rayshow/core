...
template<
	...
	typename = check_t< has_member_find< Container, Times, ValueType> >>
CCDK_FORCEINLINE auto find(Container const& ct, ValueType const& v) noexcept { 
	return ct.find<Times>(v);
}
