...
struct reverse_iterator 
{
	...
	CCDK_FORCEINLINE this_type  operator-(size_type n) const noexcept { return this_type{ it + n }; }
	CCDK_FORCEINLINE this_type& operator-=(size_type n) noexcept { it += n; return *this; }
	CCDK_FORCEINLINE size_type  operator-(this_type const& other) const noexcept { return other.it - it; }


	CCDK_FORCEINLINE decltype(auto) operator[](size_type index) noexcept { return *(it - index); }
	CCDK_FORCEINLINE decltype(auto) operator[](size_type index) const noexcept { return *(it - index); }
...
//
//template<typename It>
//struct reverse_iterator<It,true,false>
//{
//	using this_type       = reverse_iterator;
//	using traits_type     = iterator_traits<It>;
//	using value_type      = typename traits_type::value_type;
...
CCDK_FORCEINLINE bool operator==(
	...
	reverse_iterator<It> const& rhs) noexcept {
