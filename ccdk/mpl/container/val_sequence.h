...
namespace ccdk
{
	namespace mpl
	{
		...
		struct val_sequence
		{
			typedef val_sequence<T, args...> type;
			...
			constexpr auto push_back() const noexcept { return val_sequence<T, args..., c, args1...>{}; }

			template<T c, T... args1>
			constexpr auto push_front() const noexcept { return val_sequence<T, c, args1..., args...>{}; }

			template<T... args1>
			constexpr auto operator|(val_sequence<T, args1...>) const noexcept
			{
			...
			{
				return val_sequence<T, args1..., args2..., args3...>{};
			}
			...
			constexpr auto insert(integer_<I, index>, val_sequence<T, c, args1...>) const noexcept
			{
				return insert< index, c, args1...>();
			}

			template<uint32 index, T c, T... args1>
			constexpr auto insert(val_sequence<T, c, args1...>) const noexcept
			{
				return insert<index, c, args1...>();
			}
