...
namespace ccdk
{
	namespace mpl
	{
		...
		struct arg_t
		{
			...
			constexpr decltype(auto) operator()(T0&& t0, T1&& t1, T2&& t2, T3&& t3, T4&& t4, T5&& t5, Args&&... args)
			{
		...
		struct arg_t<0>
		{
			...
			constexpr decltype(auto) operator()(T&& t, Args&&... args)
			{
		...
		struct arg_t<1>
		{
			...
			constexpr decltype(auto) operator()(T0&& t0, T1&& t1, Args&&... args)
			{
		...
		struct arg_t<2>
		{
			...
			constexpr decltype(auto) operator()(T0&& t0, T1&& t1,T2&& t2, Args&&... args)
			{
		...
		struct arg_t<3>
		{
			...
			constexpr decltype(auto) operator()(T0&& t0, T1&& t1, T2&& t2, T3&& t3, Args&&... args)
			{
		...
		struct arg_t<4>
		{
			...
			constexpr decltype(auto) operator()(T0&& t0, T1&& t1, T2&& t2, T3&& t3, T4&& t4, Args&&... args)
			{
