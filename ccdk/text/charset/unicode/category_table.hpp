...
namespace category_impl
{

static constexpr uint8 category_stage1[] = {
...
static constexpr uint16 category_stage2[] = {
...
// block 100
	...
	CCDK_FORCEINLINE uint16 category_lookup(uint32 ch) {
		uint32 block_offset = category_stage1[ch / 256] * 256;
