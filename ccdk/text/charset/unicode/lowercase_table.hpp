...
namespace lowercase_impl
{
    static constexpr uint8 lowercase_stage1[] = {
...
static constexpr uint32 lowercase_stage2[] = {
...
// block 16
	...
	CCDK_FORCEINLINE uint32 lowercase_lookup(uint32 ch)
	{
		uint32 block_offset = lowercase_stage1[ch / 256] * 256;
