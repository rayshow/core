...
ccdk_namespace_string_encoding_start
...
CCDK_FORCEINLINE bool is_ascii(char32 ch) { return 0 == (ch & ~0x7f); }

CCDK_FORCEINLINE bool is_achar(char32 ch) { return is_ascii(ch); }

CCDK_FORCEINLINE bool is_alpha(char32 ch) { ccdk_assert(ch < 256);  return ascii_category_table[ch] & ascii_category::kAlpha; }

CCDK_FORCEINLINE bool is_digit(char32 ch) { ccdk_assert(ch < 256);  return ascii_category_table[ch] & ascii_category::kDigit; }

CCDK_FORCEINLINE bool is_xdigit(char32 ch) { ccdk_assert(ch < 256);  return ascii_category_table[ch] & ascii_category::kXDigit; }

CCDK_FORCEINLINE bool is_punct(char32 ch) { ccdk_assert(ch < 256);  return ascii_category_table[ch] & ascii_category::kPunct; }

CCDK_FORCEINLINE bool is_ctrl(char32 ch) { ccdk_assert(ch < 256);  return ascii_category_table[ch] & ascii_category::kCtrl; }

CCDK_FORCEINLINE bool is_space(char32 ch) { ccdk_assert(ch < 256);  return ascii_category_table[ch] & ascii_category::kSpace; }

CCDK_FORCEINLINE bool is_lower(char32 ch) { ccdk_assert(ch < 256);  return ascii_category_table[ch] & ascii_category::kLower; }

CCDK_FORCEINLINE bool is_upper(char32 ch) { ccdk_assert(ch < 256);  return ascii_category_table[ch] & ascii_category::kUpper; }

CCDK_FORCEINLINE bool is_alnum(char32 ch) { is_alpha(ch) || is_digit(ch); }

ccdk_namespace_string_encoding_end