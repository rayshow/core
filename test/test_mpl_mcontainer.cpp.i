...
namespace mpl_impl
{
 template<int32 Index, typename... Args> struct arg_pack_index_op;
 template<int32 Index, typename T, typename... Args> struct arg_pack_insert_at;
 template<typename Pack, typename... Args> struct arg_pack_merge;
...
struct arg_pack<>
{
 ...
 template<int32 Index, typename T> using insert_at = mpl_impl::arg_pack_insert_at<Index, T>;
 template<typename P> using push_front = arg_pack<P>;
 template<typename P> using push_back = arg_pack<P>;
 typedef arg_pack clear;
 template<typename P> using merge = mpl_impl::arg_pack_merge< P>;
};
template<typename T, typename... Args>
struct arg_pack<T, Args...>
{
 ...
 typedef uint32_<sizeof...(Args)+1> size;
 typedef false_ empty;
 template<int32 Index> struct at { typedef typename mpl_impl::arg_pack_index_op< Index, T, Args...>::at type; };
 template<int32 Index> using erase_at = typename mpl_impl::arg_pack_index_op< Index, T, Args...>::erase_at;
 template<int32 Index, typename T2> using insert_at = typename mpl_impl::arg_pack_insert_at<Index, T2, T, Args...>::type;
 ...
 typedef arg_pack<> clear;
 template<typename P> using merge = typename mpl_impl::arg_pack_merge< P, T, Args...>::type;
 template<int32 Index> using split = mpl_impl::arg_pack_index_op<Index - 1, T, Args...>;
};
namespace mpl_impl
{
 template<typename... Args>
 struct arg_pack_index_op<-1, Args...>
 {
  typedef arg_pack<> split_head;
  typedef arg_pack<Args...> split_tail;
 };
 template<typename T0, typename... Args>
 struct arg_pack_index_op<0, T0, Args...>
 {
  typedef T0 at;
 ...
 template<typename T0 , typename T1 , typename... Args> struct arg_pack_index_op<1, T0 , T1 , Args...> { typedef T1 at; typedef arg_pack<T0 , Args...> erase_at; typedef arg_pack<T0 , T1 > split_head; typedef arg_pack< Args...> split_tail; }; template<typename T0 , typename T1 , typename T2 , typename... Args> struct arg_pack_index_op<2, T0 , T1 , T2 , Args...> { typedef T2 at; typedef arg_pack<T0 , T1 , Args...> erase_at; typedef arg_pack<T0 , T1 , T2 > split_head; typedef arg_pack< Args...> split_tail; }; template<typename T0 , typename T1 , typename T2 , typename T3 , typename... Args> struct arg_pack_index_op<3, T0 , T1 , T2 , T3 , Args...> { typedef T3 at; typedef arg_pack<T0 , T1 , T2 , Args...> erase_at; typedef arg_pack<T0 , T1 , T2 , T3 > split_head; typedef arg_pack< Args...> split_tail; }; template<typename T0 , typename T1 , typename T2 , typename T3 , typename T4 , typename... Args> struct arg_pack_index_op<4, T0 , T1 , T2 , T3 , T4 , Args...> { typedef T4 at; typedef arg_pack<T0 , T1 , T2 , T3 , Args...> erase_at; typedef arg_pack<T0 , T1 , T2 , T3 , T4 > split_head; typedef arg_pack< Args...> split_tail; }; template<typename T0 , typename T1 , typename T2 , typename T3 , typename T4 , typename T5 , typename... Args> struct arg_pack_index_op<5, T0 , T1 , T2 , T3 , T4 , T5 , Args...> { typedef T5 at; typedef arg_pack<T0 , T1 , T2 , T3 , T4 , Args...> erase_at; typedef arg_pack<T0 , T1 , T2 , T3 , T4 , T5 > split_head; typedef arg_pack< Args...> split_tail; };;
 template<int32 Index, typename T0 , typename T1 , typename T2 , typename T3 , typename T4 , typename T5 , typename... Args>
 struct arg_pack_index_op<Index, T0 , T1 , T2 , T3 , T4 , T5 , Args...>
 {
  typedef typename arg_pack_index_op<Index - 5, Args...>::at at;
  typedef arg_pack<T0 , T1 , T2 , T3 , T4 > erase_front;
  typedef typename arg_pack_index_op<Index - 5, Args...>::erase_at erase_tail;
  typedef merge_t<erase_front, erase_tail> erase_at;
  typedef arg_pack<T0 , T1 , T2 , T3 , T4 , T5 > split_head_front;
  typedef typename arg_pack_index_op<Index - 5, Args...>::split_head split_head_tail;
  typedef typename arg_pack_index_op<Index - 5, Args...>::split_tail split_tail;
  typedef merge_t<split_head_front, split_head_tail> split_head;
 };
 template<typename T, typename... Args>
 struct arg_pack_insert_at<0, T, Args...> { typedef arg_pack<T, Args...> type; };
 template<typename T, typename T0 , typename... Args> struct arg_pack_insert_at<1, T, T0 , Args...> { typedef arg_pack< T0 , T, Args...> type; }; template<typename T, typename T0 , typename T1 , typename... Args> struct arg_pack_insert_at<2, T, T0 , T1 , Args...> { typedef arg_pack< T0 , T1 , T, Args...> type; }; template<typename T, typename T0 , typename T1 , typename T2 , typename... Args> struct arg_pack_insert_at<3, T, T0 , T1 , T2 , Args...> { typedef arg_pack< T0 , T1 , T2 , T, Args...> type; }; template<typename T, typename T0 , typename T1 , typename T2 , typename T3 , typename... Args> struct arg_pack_insert_at<4, T, T0 , T1 , T2 , T3 , Args...> { typedef arg_pack< T0 , T1 , T2 , T3 , T, Args...> type; }; template<typename T, typename T0 , typename T1 , typename T2 , typename T3 , typename T4 , typename... Args> struct arg_pack_insert_at<5, T, T0 , T1 , T2 , T3 , T4 , Args...> { typedef arg_pack< T0 , T1 , T2 , T3 , T4 , T, Args...> type; };;
 template<int32 Index, typename T0 , typename T1 , typename T2 , typename T3 , typename T4 , typename... Args>
 struct arg_pack_insert_at<Index, T0 , T1 , T2 , T3 , T4 , Args...>
 {
  typedef arg_pack< T0 , T1 , T2 , T3 , T4 > head;
  typedef typename arg_pack_insert_at<Index - 5, Args...>::type tail;
...
int main()
{
 ...
 DebugTypeName<split_head_t<pack2, 1>>();
 DebugTypeName<split_head_t<pack2, 2>>();
 DebugTypeName<split_head_t<pack2, 3>>();
 DebugTypeName<split_tail_t<pack2, 0>>();
 DebugTypeName<split_tail_t<pack2, 1>>();
 DebugTypeName<split_tail_t<pack2, 2>>();
